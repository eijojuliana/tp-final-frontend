...
export const routes: Routes = [
  ...
  { path:'menu/historial/clientes',component:HistorialClienteListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},

  { path:'menu/historial/proveedores',component:HistorialProveedorListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/empleados',component:HistorialEmpleadoListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/duenios',component:HistorialDuenioListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/tiendas',component:HistorialTiendaListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/productos',component:HistorialProductoListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/inventarios',component:HistorialInventarioListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/lotes',component:HistorialLoteListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/cuentas-bancarias',component:HistorialCuentaBancariaListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/transacciones',component:HistorialTransaccionListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/pedidos',component:HistorialPedidoListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  { path:'menu/historial/detalles-pedido',component:HistorialDetallePedidoListComponent, canActivate:AUTH_AND_SETUP, data:{roles:ADMIN_DUENIO}},
  //Rutas transacciones
